...
public class WifiConfigActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mApPasswordET = findViewById(R.id.password_text);
        mMessageTV = findViewById(R.id.message);
        mConfirmBtn = findViewById(R.id.config_btn);
    ...
    private void onWifiChanged(WifiInfo info) {
        ...
        if (disconnected) {
            ...
            mApBssidTV.setText("");
            mMessageTV.setText(R.string.no_wifi_connection);  //没有连接
            mConfirmBtn.setEnabled(false);
            ...
            mApSsidTV.setText(ssid);  //获取wifi名称
        ...
        protected void onPostExecute(List<IEsptouchResult> result) {
            ...
            mResultDialog = new AlertDialog.Builder(activity)
                    ...
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {   //监听按键时间
